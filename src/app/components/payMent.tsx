...
import { useCart } from "@/app/CartContext/CartContext"; // Cart context ko import karna

const PaymentForm: React.FC = () => {
  const { clearCart } = useCart(); // clearCart function ko use karna
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Payment processing (e.g., Stripe or PayPal integration)
    console.log("Payment Details:", formData);

    // Clear the cart after successful payment
    clearCart(); // Cart reset karna
